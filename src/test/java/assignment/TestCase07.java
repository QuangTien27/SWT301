...
public class TestCase07 {
    ...
    public void TestCase07() {
        ...
        // Step 3. Login in the application using previously created credentials
        ...
        Assert.assertTrue(actualURL.startsWith("http://live.techpanda.org/index.php/sales/order/print/order_id/"));
