...
public class TestCase03 {
    ...
    public void TestCase03_Failed() {
        ...
        Assert.assertEquals("The requested quantity for \"Sony Xperia\" is not available.", actual_error);
    ...
    public void TestCase03_Success() {
        ...
        // Step 6. Then click on EMPTY CART link in the footer of the list of all mobiles
        ...
        Assert.assertEquals("SHOPPING CART IS EMPTY", actual_message);
